    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        MajorTitle = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .Index(t => t.MajorTitle, unique: true);
            ...
            CreateTable(
                ...
                .Index(t => t.MajorID)
                .Index(t => t.RankID)
                .Index(t => t.ApplicationUserID, unique: true);
        ...
        {
            DropForeignKey("dbo.Student", "RankID", "dbo.RankStudent");
            DropForeignKey("dbo.Student", "MajorID", "dbo.Majors");
            ...
            DropIndex("dbo.Student", new[] { "RankID" });
            DropIndex("dbo.Student", new[] { "MajorID" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.RankStudent", new[] { "RankTitle" });
            DropIndex("dbo.Majors", new[] { "MajorTitle" });
